...
export default function Home() {
  return (
    <>
      <IntroAnimation />
      <main className="min-h-screen bg-[#f2e4d8] pt-24 pb-6 px-6 flex flex-col items-center justify-center text-center font-sans">
        <section id="home" className="w-full max-w-4xl">
          <div className="bg-[#fff5ed] border-[3px] border-black p-6 shadow-[8px_8px_0_0_rgba(0,0,0,1)] w-full">
        ...
        <section id="how-it-works" className="h-20"></section>
